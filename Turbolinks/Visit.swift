...
class ColdBootVisit: Visit, WKNavigationDelegate, WebViewPageLoadDelegate {
	...
	public func webView(_ webView: WKWebView, didCommit navigation: WKNavigation!) {
		Logger.logWebView(function: "ColdBootVisit.didCommit", currentVisit: self, message: navigation.debugDescription)
	}
	
	public func webView(_ webView: WKWebView, didStartProvisionalNavigation navigation: WKNavigation!) {
		Logger.logWebView(function: "ColdBootVisit.didStartProvisionalNavigation", currentVisit: self, message: navigation.debugDescription)
	}
	
	public func webViewWebContentProcessDidTerminate(_ webView: WKWebView) {
		Logger.logWebView(function: "ColdBootVisit.webViewWebContentProcessDidTerminate", currentVisit: self)
	}

	func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
		Logger.logWebView(function: "ColdBootVisit.didFinish", currentVisit: self, message: navigation.debugDescription)
	...
	func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
		Logger.logWebView(function: "ColdBootVisit.decidePolicyForAction", currentVisit: self, message: navigationAction.request.url?.absoluteString ?? "")

		// Ignore any clicked links before the cold boot finishes navigation
		if navigationAction.navigationType == .linkActivated {
			decisionHandler(.cancel)
			if let URL = navigationAction.request.url {
				print("warning: opening url", URL.absoluteString)
	...
	func webView(_ webView: WKWebView, decidePolicyFor navigationResponse: WKNavigationResponse, decisionHandler: @escaping (WKNavigationResponsePolicy) -> Void) {
		...
		Logger.logWebView(function: "ColdBootVisit.decidePolicyForResponse", currentVisit: self, message: navigationResponse.response.url?.absoluteString ?? "")
